...
import {View, Text, StyleSheet, FlatList, TouchableOpacity, SnapshotViewIOS} from 'react-native';
import {ListItem} from 'react-native-elements';
import firebase from 'firebase';
import db from '../config';
import MyHeader from '../components/MyHeader';

export default class MyBookReceivedScreen extends Component{
    constructor(){
        super();
        this.state = {
    ...
    getReceivedBooksList = ()=>{
        ...
        .onSnapshot((snapshot)=>{
            var receivedBooks = snapshot.docs.map((doc)=>doc.data())
            this.setState({
